...
from tools.tta_transform import (
    TTAOriginScaleMultiCropForY,
    MultiScaleCrop
)
...
class CustomerConfig(models.ResNeStCascadeMaskRCNNConfig):
    def __init__(self):
        ...
        self.tta_shape = ((768, 1024), (1200, 1600))
        # self.tta_shape = (768, 1024)

        self.train_transforms = T.Compose(
            transforms=[
                MultiScaleWarpBoxRandomCrop(
                    output_sizes=self.tta_shape,
                    ignore_class=[],
                    p=0.8, # [0, 12]: 0.3, (12, ) : 0.8
        ...
        self.tta_transforms = MultiScaleCrop(
            output_sizes=self.tta_shape,
