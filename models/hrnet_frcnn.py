...
import layers
from layers.det import HRNet


class HRNetFastRCNN(M.Module):

    def __init__(self, cfg):
        super().__init__()
        self.cfg = cfg
        # ----------------------- build backbone ------------------------ #
        bottom_up = HRNet(extra=dict(
            stage1=dict(
                num_modules=1,
                num_branches=1,
                block='BOTTLENECK',
        ...
        bottom_up.init_weights(pretrained='./pretrained_weights/HRNetV2p-W40.pkl')
        # ----------------------- build FPN ----------------------------- #
...
class HRNetFastRCNNConfig:
    ...
    def __init__(self):
        ...
        self.fpn_in_channels = [40, 80, 160, 320]
