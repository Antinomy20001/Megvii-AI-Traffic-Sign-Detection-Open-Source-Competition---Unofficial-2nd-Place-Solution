...
from layers.det.loss import sigmoid_focal_loss


class ResNeStFastRCNN(M.Module):
    ...
    def __init__(self, cfg):
        ...
        bottom_up.init_weights('./pretrained_weights/S-101-FPN-COCO.pkl')
        # ----------------------- build FPN ----------------------------- #
